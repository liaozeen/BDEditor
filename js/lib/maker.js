/**
 * @author lze(修改人)
 * @description 本版本的makerjs已被修改过，以适应开放需求
 */
/*
...
(function (MakerJs) {
    ...
    MakerJs.pathType = {
        ...
        AlignedDimension:"aligneddim", //标注
        Text:'text'
    };
    /**
...
(function (MakerJs) {
    ...
    (function (exporter) {
        ...
        function toDXF(itemToExport, options) {
            ...
            // 自定义文字 20210304
            map[MakerJs.pathType.Text] = function (text, offset, layer) {
                var textHeight = text.fontSize || 20
                // var textWidth = textHeight * 0.9 * getBLen(text.text)
        ...
        function outputDocument(doc) {
            ...
            var map = {};
            var default_header = ['$ACADVER','1','AC1021','$ACADMAINTVER','70','1']
            map["LINE"] = function (line) {
                append("0", "LINE", "8", line.layer,"62", line.color,"10",line.vertices[0].x, "20", line.vertices[0].y, "11", line.vertices[1].x, "21", line.vertices[1].y);
            };
            map["CIRCLE"] = function (circle) {
                append("0", "CIRCLE", "8", circle.layer,"62", circle.color, "10", circle.center.x, "20", circle.center.y, "40", circle.radius);
            };
            map["ARC"] = function (arc) {
                append("0", "ARC", "8", arc.layer,"62", arc.color, "10", arc.center.x, "20", arc.center.y, "40", arc.radius, "50", arc.startAngle, "51", arc.endAngle);
            };
            //TODO - handle scenario if any bezier seeds get passed
            //map[pathType.BezierSeed]
            ...
            function header() {
                ...
                // for(var i = 0; i < default_header.length; i=i+3){
                //     var key = default_header[i]
                //     var groupCode = default_header[i+1];
                //     var value = default_header[i+2]
                //     append("9", key, groupCode, value);
                // }
            }
